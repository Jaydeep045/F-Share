package com.jaydeep.FShare.base;
...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.jaydeep.FShare.base.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.jaydeep.FShare.base.GlideOptions().apply(toSet));
    }
  }
}
