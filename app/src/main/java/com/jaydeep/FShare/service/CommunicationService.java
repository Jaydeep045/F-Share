...
import com.jaydeep.FShare.base.AppConfig;
import com.jaydeep.FShare.base.Keyword;
import com.jaydeep.FShare.db.AccessDatabase;
import com.jaydeep.FShare.fragment.FileListFragment;
import com.jaydeep.FShare.util.AppUtils;
import com.jaydeep.FShare.util.CommunicationBridge;
import com.jaydeep.FShare.util.CommunicationNotificationHelper;
import com.jaydeep.FShare.util.DynamicNotification;
import com.jaydeep.FShare.util.FileUtils;
import com.jaydeep.FShare.util.HotspotUtils;
import com.jaydeep.FShare.util.NetworkDeviceLoader;
import com.jaydeep.FShare.util.NetworkUtils;
import com.jaydeep.FShare.util.NotificationUtils;
import com.jaydeep.FShare.util.NsdDiscovery;
import com.jaydeep.FShare.util.TimeUtils;
import com.jaydeep.FShare.util.TransferUtils;
import com.genonbeta.CoolSocket.CoolSocket;
import com.genonbeta.CoolSocket.CoolTransfer;
import com.jaydeep.FShare.R;
import com.jaydeep.FShare.model.NetworkDevice;
import com.jaydeep.FShare.model.TextStreamObject;
import com.jaydeep.FShare.model.TransferGroup;
import com.jaydeep.FShare.model.TransferInstance;
import com.jaydeep.FShare.model.TransferObject;
...
public class CommunicationService extends Service
{
    ...
    public static final String ACTION_FILE_TRANSFER = "com.jaydeep.FShare.action.FILE_TRANSFER";
    public static final String ACTION_CLIPBOARD = "com.jaydeep.FShare.action.CLIPBOARD";
    public static final String ACTION_CANCEL_INDEXING = "com.jaydeep.FShare.action.CANCEL_INDEXING";
    public static final String ACTION_IP = "com.jaydeep.FShare.action.IP";
    public static final String ACTION_END_SESSION = "com.jaydeep.FShare.action.END_SESSION";
    public static final String ACTION_SEAMLESS_RECEIVE = "com.genonbeta.intent.action.SEAMLESS_START";
    public static final String ACTION_CANCEL_JOB = "com.jaydeep.FShare.transaction.action.CANCEL_JOB";
    public static final String ACTION_TOGGLE_SEAMLESS_MODE = "com.jaydeep.FShare.transaction.action.TOGGLE_SEAMLESS_MODE";
    public static final String ACTION_REVOKE_ACCESS_PIN = "com.jaydeep.FShare.transaction.action.REVOKE_ACCESS_PIN";
    public static final String ACTION_TOGGLE_HOTSPOT = "com.jaydeep.FShare.transaction.action.TOGGLE_HOTSPOT";
    public static final String ACTION_REQUEST_HOTSPOT_STATUS = "com.jaydeep.FShare.transaction.action.REQUEST_HOTSPOT_STATUS";
    public static final String ACTION_HOTSPOT_STATUS = "com.jaydeep.FShare.transaction.action.HOTSPOT_STATUS";
    public static final String ACTION_DEVICE_ACQUAINTANCE = "com.jaydeep.FShare.transaction.action.DEVICE_ACQUAINTANCE";
    public static final String ACTION_SERVICE_STATUS = "com.jaydeep.FShare.transaction.action.SERVICE_STATUS";
    public static final String ACTION_SERVICE_CONNECTION_TRANSFER_QUEUE = "com.jaydeep.FShare.transaction.action.SERVICE_CONNECTION_TRANSFER_QUEUE";
    public static final String ACTION_TASK_STATUS_CHANGE = "com.jaydeep.FShare.transaction.action.TASK_STATUS_CHANGE";
    public static final String ACTION_TASK_RUNNING_LIST_CHANGE = "com.jaydeep.FShare.transaction.action.TASK_RUNNNIG_LIST_CHANGE";
    public static final String ACTION_REQUEST_TASK_STATUS_CHANGE = "com.jaydeep.FShare.transaction.action.REQUEST_TASK_STATUS_CHANGE";
    public static final String ACTION_REQUEST_TASK_RUNNING_LIST_CHANGE = "com.jaydeep.FShare.transaction.action.REQUEST_TASK_RUNNING_LIST_CHANGE";
    public static final String ACTION_INCOMING_TRANSFER_READY = "com.jaydeep.FShare.transaction.action.INCOMING_TRANSFER_READY";
    public static final String ACTION_TRUSTZONE_STATUS = "com.jaydeep.FShare.transaction.action.TRUSTZONE_STATUS";
    public static final String ACTION_REQUEST_TRUSTZONE_STATUS = "com.jaydeep.FShare.transaction.action.REQUEST_TRUSTZONE_STATUS";
    public static final String ACTION_TOGGLE_WEBSHARE = "com.jaydeep.FShare.transaction.action.TOGGLE_WEBSHARE";
    public static final String ACTION_WEBSHARE_STATUS = "com.jaydeep.FShare.transaction.action.WEBSHARE_STATUS";
    public static final String ACTION_REQUEST_WEBSHARE_STATUS = "com.jaydeep.FShare.transaction.action.REQUEST_WEBSHARE_STATUS";
