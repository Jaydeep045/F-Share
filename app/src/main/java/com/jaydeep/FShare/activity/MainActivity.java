...
import com.jaydeep.FShare.BuildConfig;
import com.jaydeep.FShare.fragment.HomeFragment;
    ...
    private void applyAwaitingDrawerAction()
    {
        if (mChosenMenuItemId == 0) {
         ...
         //   finish();
            ...
            wv.loadUrl("https://www.blogger.com/blog/page/edit/3397718629174717475/2093480056572974627"); //Privacy Policy
            ...
            Uri uri = Uri.parse("market://search?q=pub:" + "JDTOOLS");
            Intent goToMarket = new Intent(Intent.ACTION_VIEW, uri);
            try {
                startActivity(goToMarket);
            } catch (ActivityNotFoundException e) {
                startActivity(new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://play.google.com/store/search?q=pub:" + "JDTOOLS")));
            }
        }
