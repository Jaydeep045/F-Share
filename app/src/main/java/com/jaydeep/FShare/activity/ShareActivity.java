...
import android.content.Context;  // call it to get information regarding another part of your program
import android.content.Intent;  // message that is passed between components
import android.net.Uri;  //Uniform resource identifier
import android.os.Bundle;  //generally used for passing data from one activity to another
import android.view.View;
import android.widget.Button;  //Widgets enable users to interact with an Android Studio application page
import android.widget.ProgressBar;
import android.widget.TextView;
import android.widget.Toast;  //toast provides simple feedback about an operation in a small popup

import androidx.annotation.Nullable;

import com.jaydeep.FShare.util.OrganizeShareRunningTask;
import com.jaydeep.FShare.util.FileUtils;
import com.jaydeep.FShare.R;
import com.jaydeep.FShare.service.WorkerService;
        ...
        implements SnackbarSupport, Activity.OnPreloadArgumentWatcher, WorkerService.OnAttachListener
{
    ...
    public static final String ACTION_SEND = "genonbeta.intent.action.FShare_SEND";
    public static final String ACTION_SEND_MULTIPLE = "genonbeta.intent.action.FShare_SEND_MULTIPLE";
    ...
    private List<Uri> mFileUris;  //Uniform resource identifier
