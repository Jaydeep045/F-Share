package com.jaydeep.FShare.fragment;
...
import com.jaydeep.FShare.dialog.DeviceInfoDialog;
import com.jaydeep.FShare.util.UIConnectionUtils;
import com.jaydeep.FShare.util.DetachListener;
import com.jaydeep.FShare.util.IconSupport;
import com.jaydeep.FShare.util.NetworkDeviceSelectedListener;
import com.jaydeep.FShare.model.TitleSupport;
import com.jaydeep.FShare.util.AppUtils;
import com.jaydeep.FShare.util.ConnectionUtils;
import com.jaydeep.FShare.util.NetworkDeviceLoader;
import com.jaydeep.FShare.util.NsdDiscovery;
import com.jaydeep.FShare.R;
import com.jaydeep.FShare.activity.ConnectionManagerActivity;
import com.jaydeep.FShare.dialog.EstablishConnectionDialog;
import com.jaydeep.FShare.adapter.NetworkDeviceListAdapter;
import com.jaydeep.FShare.util.OnDeviceSelectedListener;
import com.jaydeep.FShare.model.NetworkDevice;
import com.jaydeep.FShare.service.DeviceScannerService;
        ...
        implements TitleSupport, DetachListener, IconSupport, ConnectionManagerActivity.DeviceSelectionSupport
{
    ...
    private void openInfo(NetworkDevice device)
    {
        if (device instanceof NetworkDeviceListAdapter.HotspotNetwork) {
            ...
            builder.setMessage(R.string.text_FShareHotspotDescription);
